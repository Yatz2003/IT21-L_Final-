...
const Login = () => {
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-160px)] max-w-6xl items-center justify-center px-4 py-6">
      <div className="relative w-full max-w-2xl overflow-hidden rounded-3xl border border-[#0f172a] bg-[#101728]/90 p-4 text-[#E5F1FF] shadow-[0_0_40px_rgba(0,245,255,0.08)] backdrop-blur-xl sm:p-8">
        ...
        <div className="relative space-y-8">
          <div className="space-y-4">
            <div className="text-[#00F5FF]">
              <h1 className="text-lg font-semibold uppercase tracking-tight sm:text-4xl sm:tracking-[0.36em] text-center leading-tight break-words">CyberVault</h1>
